                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="street_ct" type="text" name="contentData[street_ct]" placeholder="{#ph_tr_street#|ucfirst}" value="" class="form-control to-required" {*required*}/>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="city_ct" class="is_empty">{#pn_city_ct#|ucfirst}&nbsp;*:</label>
                            <input id="city_ct" type="text" name="contentData[city_ct]" placeholder="{#ph_city_ct#|ucfirst}" class="form-control to-required" required/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="postcode_ct" type="text" name="contentData[postcode_ct]" placeholder="{#ph_postcode_ct#|ucfirst}" class="form-control to-required" required/>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
