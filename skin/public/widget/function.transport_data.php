 ...
 * @subpackage plugins
 */
function smarty_function_transport_data($params, $smarty){
    $transport = new plugins_transport_public();
    ...
    /*$modelTemplate->addConfigFile(
        array(component_core_system::basePath().'/plugins/transport/i18n/'),
        array('public_local_'),
        false
    );
    $modelTemplate->configLoad();*/
    $data = $transport->getBuildList();
    $smarty->assign(isset($params['assign']) ? $params['assign'] : 'transport',$data);
}